...
function Contact() {
  return (
    <section id='contact' className={`${styles.paddingX}`}>
      <div className={'flex justify-between flex-col 2xl:flex-row 2xl:px-20 items-center p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100'}>
