...
function Contact() {
  return (
    <section id='contact' className='bg-ghost-white'>
      <div className={'flex justify-between flex-col 2xl:flex-row 2xl:px-20 items-center p-6 bg-ghost-white border border-gray-200 rounded-lg shadow-lg hover:bg-gray-100'}>
